...
class DiaryEntryForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "date_of_journey": forms.DateInput(
                attrs={
                    "type": "date",
                    "class": "form-control",
            ...
            "destination_date": forms.DateInput(
                attrs={
                    "type": "date",
                    "class": "form-control",
                    "placeholder": "YYYY-MM-DD",
...
class DiaryEntrySearchForm(forms.Form):
    ...
    time_period = forms.ChoiceField(
        label="Time Period",
        choices=[("", "All")]
        + DiaryEntry.TIME_PERIOD_CHOICES,  # Include an option for all time periods
        required=False,
    )
